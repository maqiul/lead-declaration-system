<template>
  <div class="payment-method-management px-6 py-6 bg-slate-50 min-h-full">
    ...
    <a-card class="ui-card mb-4" :bordered="false">
      <a-space>
        <a-button type="primary" @click="openAddModal" v-permission="['system:payment:add']" class="ui-btn-cta">
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <a-space>
              <a-button type="link" size="small" @click="openEditModal(record as PaymentMethod)" v-permission="['system:payment:edit']" class="text-blue-600 font-medium">编辑</a-button>
              <a-popconfirm
                title="确定要切换状态吗？"
