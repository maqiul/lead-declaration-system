      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <a-space>
              <a-button type="link" size="small" @click="openEditModal(record as PaymentMethod)" v-permission="['system:payment:update']" class="text-blue-600 font-medium">
              ...
              >
                <a-button type="link" size="small" danger v-permission="['system:payment:delete']" class="font-medium">
