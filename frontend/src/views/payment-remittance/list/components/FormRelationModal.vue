    ...
    <a-card title="已关联的申报单" size="small" style="margin-bottom: 16px">
      <template #extra>
        <a-space>
          ...
          <a-button type="primary" size="small" @click="showAddForm" v-permission="['business:payment-remittance:update']">
...
import { getRelatedForms, relateToForm, unrelateFromForm } from '@/api/business/paymentRemittance'
