...
(600, '财务票据管理', 0, 1, '/financial', 'Layout', NULL, 'MoneyCollectOutlined', 7, 1, 1, 0, NOW(), NOW()),
(700, '城市管理', 0, 1, '/city-management', 'Layout', NULL, 'EnvironmentOutlined', 8, 1, 1, 0, NOW(), NOW());
...
-- [城市管理模块] (parent_id=700)
INSERT INTO sys_menu (id, menu_name, parent_id, menu_type, path, component, permission, icon, sort, is_show, status, deleted, create_time, update_time) VALUES
(701, '城市信息', 700, 2, 'city-info', '@/views/system/city-info/index.vue', 'system:city-info:list', 'EnvironmentOutlined', 1, 1, 1, 0, NOW(), NOW());
...
-- 城市信息管理按钮 (701)
INSERT INTO sys_menu (id, menu_name, parent_id, menu_type, path, component, permission, sort, is_show, status, deleted, create_time, update_time) VALUES
(7011, '城市查询', 701, 3, '', '', 'system:city-info:query', 1, 1, 1, 0, NOW(), NOW()),
(7012, '城市新增', 701, 3, '', '', 'system:city-info:add', 2, 1, 1, 0, NOW(), NOW()),
(7013, '城市编辑', 701, 3, '', '', 'system:city-info:update', 3, 1, 1, 0, NOW(), NOW()),
(7014, '城市删除', 701, 3, '', '', 'system:city-info:delete', 4, 1, 1, 0, NOW(), NOW()),
(7015, '城市列表', 701, 3, '', '', 'system:city-info:list', 5, 1, 1, 0, NOW(), NOW());
